...
const Hero = () => {
  return (
    <section className="relative min-h-screen flex flex-col justify-center items-center bg-gradient-to-r from-blue-900 via-purple-900 to-teal-800 text-white text-center overflow-hidden">
      ...
      {/* Profile Image Container with white background */}
      <motion.div
      ...
      {/* Description */}
      <motion.p
        className="text-xl md:text-2xl mb-6 z-10"
        initial={{ y: 50, opacity: 0 }}
        animate={{ y: 0, opacity: 1 }}
        transition={{ duration: 1, delay: 0.3 }}
      >
        Aspiring AI & ML Engineer | Web Development Enthusiast | Exploring Opportunities in AI-driven Solutions
      </motion.p>
      ...
      >
        <a 
          href="/Resume-1.pdf"
          download 
          className="bg-teal-400 text-white px-6 py-3 rounded-full font-semibold shadow-lg hover:bg-teal-500 hover:scale-105 transition"
        >
          Download Resume
        </a>
        <a 
